...
{
	_ACH_ID(EAchievements::ACH_WIN_ONE_GAME, "Winner"),
	_ACH_ID(EAchievements::ACH_WIN_100_GAMES, "Champion"),
	_ACH_ID(EAchievements::ACH_TRAVEL_FAR_ACCUM, "Interstellar"),
	_ACH_ID(EAchievements::ACH_TRAVEL_FAR_SINGLE, "Orbiter"),
};
...
bool CSteamAchievements::RequestStats()
{
	...
	// Request user stats.
	return SteamUserStats()->RequestUserStats(SteamUser()->GetSteamID());
}
